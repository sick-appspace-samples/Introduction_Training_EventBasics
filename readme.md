## Introduction_Training_EventBasics
Short SampleApp to explain the different scopes and interactions
...
The purpose of this one is to introduce the different scopes and how to work
with them, i.e. to utilize the interactions.

### Topics
training, introduction, event, function, loop, global, scope, sampleapp, sick-appspace
